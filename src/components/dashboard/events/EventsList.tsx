...
export default function EventsList() {
  ...
  // Charge les événements au chargement du composant
  useEffect(() => {
  ...
  // Filtre les événements en fonction du statut et du terme de recherche
  ...
  // Vérifie si tous les événements sont sélectionnés
  ...
  // Gestion de la sélection de tous les événements
  ...
  // Préparation de la suppression d'un événement
  const confirmDeleteEvent = (eventId: string) => {
    setEventToDelete(eventId);
    setIsConfirmDialogOpen(true);
  };

  // Suppression effective d'un événement
