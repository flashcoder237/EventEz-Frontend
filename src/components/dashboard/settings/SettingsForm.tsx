  ...
  return (
    <div className="space-y-8">
          ...
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Décidez comment vous souhaitez être notifié des mises à jour.
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">
                      Recevez des emails concernant vos événements et inscriptions.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">
                      Recevez des SMS pour les mises à jour importantes (des frais peuvent s'appliquer).
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="event_reminders" className="font-medium text-gray-700">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">
                      Recevez des emails sur les nouveaux événements et offres spéciales.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6 mt-6">
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Personnalisez votre expérience sur EventEz.
              </p>
            </div>
            <div className="mt-5 md:mt-0 md:col-span-2">
            ...
            <div className="mt-5 md:mt-0 md:col-span-2">
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="two_factor_auth" className="font-medium text-gray-700">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="login_notifications" className="font-medium text-gray-700">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="public_profile" className="font-medium text-gray-700">
                      Profil public
                    </label>
                    <p className="text-gray-500">
                      Permettre aux autres utilisateurs de voir votre profil et vos événements.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6 mt-6">
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <h3 className="text-lg font-medium leading-6 text-gray-900">Actions de compte</h3>
            <p className="mt-1 text-sm text-gray-500">
          ...
          <div className="mt-5 md:mt-0 md:col-span-2">
            <div className="space-y-6">
              <div>
                <h4 className="text-sm font-medium text-gray-700">Déconnexion</h4>
                <p className="mt-1 text-sm text-gray-500">
                ...
                <button
                  ...
                  className="mt-3 inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
                >
              ...
              <div className="pt-6 border-t border-gray-200">
                <h4 className="text-sm font-medium text-red-700">Zone de danger</h4>
                <p className="mt-1 text-sm text-gray-500">
                ...
                {!showDeleteConfirm ? (
                  ...
                  <div className="mt-3 space-y-4 p-4 border border-red-300 rounded-md bg-red-50">
