...
export default function ContactInfo({ animationTriggered }) {
  ...
  const iconComponents = {
    ...
    linkedin: <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" />
  };
    ...
    >
      ...
      <div className="space-y-6">
        <ContactInfoItem 
          ...
          title="Email" 
          info={["contact@eventez.cm", "support@eventez.cm"]} 
        ...
        <ContactInfoItem 
          ...
          title="Téléphone" 
          info={["+237 670 000 000", "+237 696 000 000"]} 
          animationTriggered={animationTriggered}
          delay={0.2}
        />
        ...
        <ContactInfoItem 
          ...
          title="Adresse" 
          info={["Immeuble Nko'o, Rue des Écoles", "Yaoundé, Cameroun"]} 
          animationTriggered={animationTriggered}
          delay={0.3}
        />
        ...
        <ContactInfoItem 
          ...
          title="Horaires" 
          info={["Lun-Ven: 8h00 - 18h00", "Sam: 9h00 - 13h00"]} 
          animationTriggered={animationTriggered}
          delay={0.4}
        />
      </div>
...
function ContactInfoItem({ icon, title, info, animationTriggered, delay }) {
  return (
    <motion.div 
    ...
    >
      ...
      <div>
        ...
        {info.map((line, index) => (
          <p key={index} className="text-indigo-100">{line}</p>
        ))}
      </div>
    </motion.div>
  );
